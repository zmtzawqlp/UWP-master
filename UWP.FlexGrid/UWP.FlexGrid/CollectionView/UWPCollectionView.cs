...
namespace UWP.FlexGrid.CollectionView
{
    ...
    public class UWPCollectionView :
        ICollectionViewEx,
        ...
        IComparer<object>
    {
        ...
        public UWPCollectionView(object source)
        {
        ...
        public UWPCollectionView() : this(null) { }
        ...
        {
            UWPCollectionView _view;
            object _currentItem;

            internal DeferNotifications(UWPCollectionView view)
            {
                _view = view;
        ...
        public bool HasMoreItems { get { return _source is ISupportIncrementalLoading ? (_source as ISupportIncrementalLoading).HasMoreItems : false; } }
        public IAsyncOperation<LoadMoreItemsResult> LoadMoreItemsAsync(uint count)
        {
            if (_source is ISupportIncrementalLoading)
            {
